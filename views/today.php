...
require_once('../controllers/today.php');
?>
<!doctype html>
<html>
	<head>
		<title>ESIS-OJ | Publication du jour</title>
		<!-- METAS -->
	...
	<body>
        ...
        <main>
            <div class="container">
                <h1 class="h1-responsive flex-center">Publication du jour</h1>
                <hr/>
                <div class="container-fluid">
                    <?php if(empty($today)){
                        echo "
                                <br/>
                                <h3 class='text-danger text'>Aucune publication aujourd'hui</h3>
                                <br/>
                            ";
                    }else{foreach ($today as $msg){?>
                ...
                <hr/>
                <a class="btn btn-default btn-lg" href="new.php">Publier</a>
            </div>
        </main>
