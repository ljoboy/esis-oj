...
require_once('../controllers/top10.php');
?>
<!doctype html>
<html>
<head>
    <title>ESIS-OJ | Top 10</title>
    <!-- METAS -->
                ...
                <blockquote class="blockquote <?php if ($msg['idEtudiant'] == $_SESSION['user']['id']) { echo "blockquote-reverse"; }?>">
                    ...
                    <footer class="blockquote-footer">
                        ...
                        <cite class="text-muted">
                            &emsp; <a href="like.php?like=<?php echo $msg['id'] ?>" title="like"><i class="fa fa-thumbs-up"></i>(<?php echo $msg['nblike'] ?>)</a>
                            &emsp; <a title="dislike" href="like.php?dislike=<?php echo $msg['id'] ?>"><i class="fa fa-thumbs-down"></i>(<?php echo $msg['nbdislike'] ?>)</a>
                            &emsp; <a title="Comment" href="comment.php?id=<?php echo $msg['id'] ?>"><i class="fa fa-comments" aria-hidden="true"></i>(0)</a>
                        </cite>
                    </footer>
                </blockquote>
            <?php } }?>
